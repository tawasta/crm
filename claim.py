...
class crm_claim(osv.Model):      
    ...
    def _init_claim_numbers(self, cr, uid, ids=None, context=None):
        ''' When the module is installed, fetch all claims without a number and assign them one. This should only activate once. '''
    ...
    def create(self, cr, uid, vals, context=None):
        ''' Overrides the default create to add some functionality '''
